...
dem_small <- aggregate(dem, fact = 3)

dem_ll <- project(dem_small, "EPSG:4326")

flood <- read.csv("output_data/flood_events_miami.csv")
flood_sf <- st_as_sf(flood, coords = c("longitude", "latitude"), crs = 4326)
